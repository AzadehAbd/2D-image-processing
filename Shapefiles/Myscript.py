...
districts = gpd.read_file(r'D:\Spyder code and data\Introduction to GeoPandas\Shapefiles\districts.shp')
...
area_of_interest = gpd.read_file(r'D:\Spyder code and data\Introduction to GeoPandas\Shapefiles\area_of_interest.shp')
area_of_interest.plot()

atms = gpd.read_file(r'D:\Spyder code and data\Introduction to GeoPandas\Shapefiles\atms.shp')
